...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color tertiary = const Color(0xFFBBDEFB);
  ...
  late Color accent1 = const Color(0xFF81D4FA);
  late Color accent2 = const Color(0xFF4FC3F7);
  late Color accent3 = const Color(0xFF29B6F6);
  ...
  late Color info = const Color(0xFF536DFE);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF0F5AAB);
  late Color secondary = const Color(0xFF2196F3);
  late Color tertiary = const Color(0xFF64B5F6);
  late Color alternate = const Color(0xFFBBDEFB);
  ...
  late Color accent1 = const Color(0xFF4FC3F7);
  late Color accent2 = const Color(0xFF29B6F6);
  late Color accent3 = const Color(0xFF03A9F4);
  late Color accent4 = const Color(0xFF039BE5);
  ...
  late Color info = const Color(0xFF304FFE);
}
