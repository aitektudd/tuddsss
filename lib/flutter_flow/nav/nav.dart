      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'HomeTudds')
              : const HomeTuddsWidget(),
        ),
        FFRoute(
          name: 'History',
          path: '/history',
        ...
        FFRoute(
          ...
          builder: (context, params) =>
              params.isEmpty ? const NavBarPage(initialPage: 'Music') : const MusicWidget(),
        ),
        FFRoute(
          name: 'Shop',
          path: '/shop',
        ...
        FFRoute(
          ...
          path: '/details',
          asyncParams: {
            'services': getDoc(['services'], ServicesRecord.fromSnapshot),
          },
